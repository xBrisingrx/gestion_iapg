class FormbigBuilder < ActionView::Helpers::FormBuilder
  ...
  def label(method, text = nil, options = {})
    content_tag :div, class: "col-6 col-sm-4 col-lg-3 col-xl-2" do
  ...
  [ :text_field, :number_field, :date_field, :time_field, :email_field, :password_field, :file_field ].each do |method|
